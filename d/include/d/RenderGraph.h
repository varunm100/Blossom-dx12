...
struct EmptyPayload {};
//  template<typename T>
//  concept WorkPayload = std::same_as<T, GraphicsWorkPayload> ||
//  std::same_as<T, ComputeWorkPayload> ||
...
struct RenderGraph {
  ...
  void add_work(WorkPayload &&_payload, WorkType _type,
                std::initializer_list<Handle> _in_res,
